...
// Incluye el archivo de configuración y los datos de sesión del usuario
...
// Recuperar el número de factura siguiente
...
/////////////////////////////////////////////
    ...
    <html lang="es">
    <head>
            <!-- Incluye el head común a todas las páginas -->
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <h2>Bienvenido al SISTEMA DE PARQUEO - NEIVA YORK <img src="https://cdn.icon-icons.com/icons2/110/PNG/96/studebaker_station_wagon_18541.png" height="50" width="50"></h2>

                    <!-- Se crea el mapa del parqueadero -->
                                        ...
                                        if($estado_espacio == "LIBRE"){ ?>
                                            <div class="col">
                                                <center>
                                                    ...
                                                    <!-- Botón verde que representa el estado libre del espacio -->
                                                    ...
                                                    <!-- Modal para el ingreso del vehículo -->
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            ...
                                                                            <!-- Script para realizar la búsqueda del cliente -->
                                                                            <script>
                                                                    ...
                                                                    <!-- Aquí se mostrará la respuesta de la búsqueda del cliente -->
                                                                    <div id="respuesta_buscar_cliente<?php echo $id_map;?>">

                                                                    </div>
                                                                    <!-- Continuación del código PHP y HTML con fechas ,horas,meses , años ycubiculo -->
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                                     ...
                                                                     <button type="button" class="btn btn-primary" id="btn_registrar_ticket<?php echo $id_map;?>" onclick="reloadAndOpenTickets()">Imprimir ticket</button>
                                                                        <!-- Script para manejar el evento de impresión de ticket -->
                                                                        <script>
                                                                            function reloadAndOpenTickets() {
                                                                        ...
                                                                        // Recuperar los valores de los campos del formulario
                                                                         ...
                                                                         // Validar que los campos obligatorios no estén vacíos
                                                                           if(placa == ""){
                                                                             ...
                                                                             // Realizar acciones en el servidor para cambiar el estado del espacio de estacionamiento, registrar el cliente y generar el ticket
                                                                ...
                                                                <!-- Cierre del bucle foreach y de otros elementos HTML y registra resuestas del ticket -->
                                            ...
                                            <!-- Bucle foreach para iterar sobre los espacios de estacionamiento y mostrar su estado-->
                                                                        
                                        <?php
                                        }
                                        if($estado_espacio == "OCUPADO"){ ?>
                                            <!-- Mostrar el espacio de estacionamiento ocupado -->
                                            <div class="col">
                                                <center>
                                                    <h2><?php echo $nro_espacio;?></h2>
                                                    ...
                                                    // Consulta para obtener los datos del cliente asociados al espacio ocupado
                                                    ...
                                                    ?>
                                                    <!-- muestra el Modal de los datos del cliente -->
                                                    <div class="modal fade" id="exampleModal<?php echo $id_map;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <!-- Contenido del modal -->
                                                                    <!-- Campos de información del cliente gestionando un formulario  -->
                                                                ...
                                                                <div class="modal-footer">
                                                                <!-- Botones para interactuar con el cliente -->
                                                                    ...
                                                                    <button type="button" class="btn btn-success" id="btn_facturar<?php echo $id_map;?>" onclick="reloadAndOpenFactura()">Facturar</button>
                                                                    <script>
                                                                        function reloadAndOpenFactura() {
                                                                            //abre el link de factura en otra ventana
                                                                        window.open('facturacion/factura.php', '_blank');
                                                                        //recargar la pagina
                                                                        window.location.reload();                                                                     
                                                                        }
                                                                        </script>
                                                                    <?php
                                                                    //JavaScript para manejar la acción de facturar 
                                                                    ...
                                                                    //sesion para validar la informacion de validar
                                                                    ?>
                                                                    <script>
                                                                        $('#btn_facturar<?php echo $id_map;?>').click(function () {
                                                                            ...
                                                                            // Registra factura y redirecciona al controlador para gestionarla
                                                                ...
                                                                <!-- Contenedor para la respuesta de la factura -->
                                                    ...
                                                    <!-- el estado del parqueo: libre  o reservado-->
                                                    <p><?php echo $estado_espacio;?></p>
                                                </center>
                                            </div>
                                            <?php
